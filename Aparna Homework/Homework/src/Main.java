...
class Main {
    public static void main(String[] args) {
        ...
        if (parsedArgs == null || parsedArgs.isEmpty() || !parsedArgs.containsKey("-start") || !parsedArgs.containsKey("-target")) {
            System.out.println("Start or target location is missing.");
            return;
        }
        ...
        // Show the map
        String solvedMap = map.getSolvedMap(start, target);
        printMap(solvedMap);
    }
     ...
     *
     * @param map The map array to print
     */
     ...
     * @return The list of obstacles parsed from the arguments
     */
